...
```
   #+end_src
** Commands
*** Correct spelling errors in the sentence
...
* Generate system prompts for =gptel=
  ...
  + type: alist
    ...
    #+begin_src emacs-lisp :results none :tangle gptel-build-custom-directives.el :comments org
    ...
    #+begin_src emacs-lisp :results none
      (setq gptel-custom-directives (gjg/gptel-build-custom-directives "~/.dotfiles/ai/system-prompts/"))
    #+end_src
